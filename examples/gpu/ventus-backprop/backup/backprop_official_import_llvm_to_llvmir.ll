...
define void @bpnn_layerforward_ocl(ptr addrspace(1) %0, ptr addrspace(1) %1, ptr addrspace(1) %2, ptr addrspace(1) %3, ptr addrspace(3) %4, ptr addrspace(3) %5, i32 %6, i32 %7) {
...
declare i32 @_Z12get_group_idj(i32) #0

; Function Attrs: memory(none)
declare i32 @_Z12get_local_idj(i32) #0

; Function Attrs: nounwind
declare void @llvm.riscv.ventus.barrier(i32 immarg) #1

define void @bpnn_adjust_weights_ocl(ptr addrspace(1) %0, i32 %1, ptr addrspace(1) %2, i32 %3, ptr addrspace(1) %4, ptr addrspace(1) %5) {
